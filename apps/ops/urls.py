...
urlpatterns = [
    ...
    path("catalogo/id/<int:pk>/", views.catalog_admin_detail_by_pk, name="catalog_admin_detail_by_pk"),
    path("catalogo/id/<int:pk>/editar/", views.catalog_admin_edit_by_pk, name="catalog_admin_edit_by_pk"),
    path("catalogo/id/<int:pk>/eliminar/", views.catalog_admin_delete_by_pk, name="catalog_admin_delete_by_pk"),
